...
C_SRCS += \
$(SOURCE_PATH)/Sources/APP/APP_IFACE/app_iface.c 

OBJS += \
./Sources/APP/APP_IFACE/app_iface.o 

C_DEPS += \
./Sources/APP/APP_IFACE/app_iface.d 


# Each subdirectory must supply rules for building sources it contributes
Sources/APP/APP_IFACE/app_iface.o: $(SOURCE_PATH)/Sources/APP/APP_IFACE/app_iface.c Sources/APP/APP_IFACE/subdir.mk
...
clean: clean-Sources-2f-APP-2f-APP_IFACE

clean-Sources-2f-APP-2f-APP_IFACE:
	-$(RM) ./Sources/APP/APP_IFACE/app_iface.cyclo ./Sources/APP/APP_IFACE/app_iface.d ./Sources/APP/APP_IFACE/app_iface.o ./Sources/APP/APP_IFACE/app_iface.su

.PHONY: clean-Sources-2f-APP-2f-APP_IFACE
