...
C_SRCS += \
$(SOURCE_PATH)/Sources/Test/test.c 
...
Sources/Test/test.o: $(SOURCE_PATH)/Sources/Test/test.c Sources/Test/subdir.mk
...
clean: clean-Sources-2f-Test

clean-Sources-2f-Test:
	-$(RM) ./Sources/Test/test.cyclo ./Sources/Test/test.d ./Sources/Test/test.o ./Sources/Test/test.su

.PHONY: clean-Sources-2f-Test
